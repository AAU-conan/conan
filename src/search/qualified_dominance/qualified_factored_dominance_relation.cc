...
namespace qdominance {
    ...
    double QualifiedFactoredDominanceRelation::get_percentage_equal() const {
        double percentage = 1;
        for (auto &sim: local_relations) {
    ...
    double QualifiedFactoredDominanceRelation::get_percentage_equivalences() const {
        double percentage = 1;
        for (auto &sim: local_relations) {
    ...
    int QualifiedFactoredDominanceRelation::num_equivalences() const {
        int res = 0;
    ...
    double QualifiedFactoredDominanceRelation::num_states_problem() const {
        double res = 1;
        for (size_t i = 0; i < local_relations.size(); i++) {
    ...
    void QualifiedFactoredDominanceRelation::dump_statistics(utils::LogProxy &log) const {
