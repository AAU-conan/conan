...
//s is equivalent to s'.
    ...
    bool QualifiedLocalStateRelation::update(const QualifiedLabelRelation& label_relation) {
    ...
    bool QualifiedLocalStateRelation::noop_simulates_tr(int t, LTSTransition s_tr, const QualifiedLabelRelation& label_relation) const {
        return label_relation.noop_simulates_label_group_in_all_other(factor, s_tr.label_group) && simulates(t, s_tr.target);
    }

    bool QualifiedLocalStateRelation::tr_simulates_tr(const LTSTransition& t_tr, const LTSTransition& s_tr, const QualifiedLabelRelation& label_relation) const {
    ...
    bool QualifiedLocalStateRelation::update_pairs(const QualifiedLabelRelation& label_relation) {
    ...
    QualifiedLocalStateRelation::QualifiedLocalStateRelation(const LabelledTransitionSystem& lts, int factor, const FTSTask& fts_task)
