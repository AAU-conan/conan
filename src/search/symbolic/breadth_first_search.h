...
namespace symbolic {
    ...
    public:
        BreadthFirstSearch(SymController *eng, const SymParamsSearch &params, std::shared_ptr<AbstractTask> &_task);
        ...
        virtual void getPlan(const BDD &, int, int, std::vector<OperatorID> &) const {
        }
